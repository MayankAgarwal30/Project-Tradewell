...
class StoreLoginController extends Controller
{
	...
	elseif( $checkUser->phone_verified==0 && $firebase->status==0){
    	...
    	{
            $message = array('status'=>0, 'message'=>"You are not registered yet please contact Admin");
            return $message;
    	}
     ...
     public function store_current_status(Request $request)
    {
        ...
        if($profile){
                 ...
                 $message = array('status'=>'1', 'message'=>'Store Status Updated', 'data'=>[$profile]);
                 return $message;
