   ...
   public function orderlist(Request $request)
    ...
    {   
        ...
        $oder = DB::table('order_by_photo')
                ...
                ->select('order_by_photo.ord_id','order_by_photo.user_id','order_by_photo.list_photo','order_by_photo.store_id','order_by_photo.address_id','order_by_photo.time_slot','user_address.address','order_by_photo.delivery_date','tbl_user.user_name')
                ->where('store_id',$store_id)
                ->get();
