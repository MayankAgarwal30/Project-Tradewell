        ...
        if($update){
          ...
          $cartreward = DB::table('reward_history')
            ...
            $comission = DB::table('comission')   
                        ->insert(['cart_id'=>$cart_id, 'vendor_id'=>$vendor_id, 'vendor_name'=>$vendor_name,'comission_price'=>$comission_value,'order_date'=>$order_date,'user_name'=>$user_name,'status'=>'Pending','total_price'=>$product_price,'payment_method'=>$payment_method,'delivery_boy_id'=>$delivery_boy_id]);
