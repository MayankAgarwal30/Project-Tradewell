...
class paymentController extends Controller
{
    ...
    {  
        ...
        $payment = DB::table('payment_mode')
         ...
         if($currency){
            $message = array('status'=>'1', 'message'=>'Payment Gateways and Values', 'razorpay'=>$razorpay, 'paypal'=>$paypal, 'stripe'=>$stripe, "paystack"=>$paystack,"paymongo"=>$paymongo, 'payment_status'=>$payment);
            return $message;
            }
        else{
