                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{route('addcoupon')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="coupon_name" placeholder="{{ __('messages.Enter_product_name')}}">
                    </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="coupon_discount" placeholder="{{ __('messages.Enter_Amount')}}">
                    </div>
