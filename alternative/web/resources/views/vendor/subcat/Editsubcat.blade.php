...
<div class="content-wrapper">
		  ...
		  <div class="col-md-2">
            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">{{ __('messages.Update_sub_category')}}</h4>
                   @if (count($errors) > 0)
                      @if($errors->any())
                  ...
                  <form class="forms-sample" action="{{route('vendorUpdatesubcat',$subcat->subcat_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" value="{{$subcat->subcat_name}}" name="subcat_name" placeholder="{{ __('messages.Enter_SubCategory_Name')}}">
                    </div>
                    <!-- <div class="form-group">-->
