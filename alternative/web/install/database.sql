...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 13, 2021 at 09:30 AM
...
CREATE TABLE `payment_mode` (
  ...
  `cod_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `payment_mode` (`pay_id`, `payment_status`, `cod_status`) VALUES
(1, 'on', 'on');
