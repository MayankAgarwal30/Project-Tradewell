  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(locale.addcharge, style: Theme.of(context).textTheme.bodyText1),
        titleSpacing: 0.0,
      ),
    ...
    return Column(
      children: [
        ...
        Align(
          ...
          child: BottomBar(
            text: locale.AddCityCharge,
            onTap: () {
              if (!isFetch) {
                showProgressDialog(locale.AddCityCharge1, pr);
    ...
    if (productNameC.text.isNotEmpty && productQuantityC.text.isNotEmpty) {
      ...
      client.post(urlhit, body: {
        ...
        if (value.statusCode == 200) {
          var jsonData = jsonDecode(value.body);
          if (jsonData['status'] == "1") {
            Toast.show(locale.charadd, contexts,
