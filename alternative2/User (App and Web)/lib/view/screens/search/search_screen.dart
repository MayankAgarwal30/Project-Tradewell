                            ...
                            child: CustomTextField(
                              ...
                              onSubmit: (text) {
                                if (_searchController.text.length > 0) {
                                  ...
                                  Navigator.pushNamed(context, RouteHelper.searchResult+'?text=${_searchController.text}', arguments: SearchResultScreen(searchString: _searchController.text));
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => InkWell(
                                  onTap: () {
                                    ...
                                    Navigator.pushNamed(context, RouteHelper.searchResult+'?text=${searchProvider.historyList[index]}', arguments: SearchResultScreen(searchString: searchProvider.historyList[index]));
